...
void setup() {
  ...
  pinMode(6, OUTPUT);                                                 //Set output 13 (LED) as output
  
  setup_mpu_6050_registers();                                          //Setup the registers of the MPU-6050 (500dfs / +/-8g) and start the gyro

  digitalWrite(6, HIGH);                                              //Set digital output 13 high to indicate startup
  ...
  digitalWrite(6, LOW);                                               //All done, turn the LED off
...
void loop(){
  ...
  angle_yaw += gyro_z * 0.0000611;//my edit
  ...
  angle_yaw_output = angle_yaw_output * 0.9 + angle_yaw * 0.1;  //my edit
  yaw = angle_yaw_output / 2.0;
//  long intercept = 0.0055;
//  long m = -.00103;
//  yaw = yaw - (m*count + intercept); 
//  count += 1;
